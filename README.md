...
Подробную инструкцию по установке, настройке и использованию модуля вы можете [скачать тут](https://arsenalpay.ru/instructions/WebAsyst_%D0%A1%D0%9C%D0%A1_instruction.pdf).
...
2. Загрузите все содержимое из папки arsenalpay/ плагина в папку wa-plugins/payments/arsenalpay/ Вашего сервера (Для проверки, полный путь к основному файлу плагина в примере выше будет: {путь до CMS}/wa-plugins/payment/arsenalpay/lib/arsenalpayPayment.class.php)
...
4. Закончив, сохраните настройки нажатием на **Сохранить**.
